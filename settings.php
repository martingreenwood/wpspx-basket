...
function wpspx_basket_frontend_scripts()
{
	...
	wp_register_script( 'wpspx_basket_front', WPSPX_BASKET_PLUGIN_URL . 'lib/assets/js/wpspx-basket-front.js', array(), false, true );
	wp_enqueue_script( 'wpspx_basket_front' );
}

function wpspx_basket_enqueue_color_picker() {
    wp_enqueue_style( 'wp-color-picker' );
    wp_enqueue_script( 'wpspx_basket_js', WPSPX_BASKET_PLUGIN_URL . 'lib/assets/js/wpspx-basket.js', array( 'wp-color-picker' ), false, true );
}

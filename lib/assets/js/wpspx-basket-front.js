...
jQuery(document).ready(function($){
	...
	$('.wpspxbasket').on('click', function(){
		...
		$.each(donations, function(i, dn) {
			...
			// .tributeName
			// .tributeTypeId
			itemList.push('<div class="wpspx-basket-item" data-basket-id="'+basketId+'"><div class="wpspx-item-info"><div class="wpspx-title"><span>Donation</span></div><div class="amount"><span class="wpspx-price-symbol">'+ currencyChar + $.number( dn.amount, currencyDecimalPlaces) +'</span></div></div></div>');
		});
		...
		$.each(giftVouchers, function(i, gv) {
			...
			itemList.push('<div class="wpspx-basket-item" data-basket-id="'+basketId+'"><div class="wpspx-item-info"><div class="wpspx-title"><span>Gift Voucher</span></div><div class="amount"><span class="wpspx-price-symbol">'+ currencyChar + $.number( gv.amount, currencyDecimalPlaces) +'</span></div><div class="view-additional-details"><i class="far fa-info-circle"></i></div><div class="additional-details"><dl><dt>From:</dt><dd>'+gv.fromName+'</dd><dt>To:</dt><dd>'+gv.toName+'</dd><dt>Message:</dt><dd>'+gv.message+'</dd><dt>Date to send:</dt><dd>'+sendDate+'</dd></dl></div></div></div>');
		});
		...
		$.each(donationsMatches, function(i, ms) {
			...
			itemList.push('<div class="wpspx-basket-item" data-basket-id="'+basketId+'"><div class="wpspx-item-info"><div class="wpspx-title"><span>'+ms.membership.name+'</span></div><div class="amount"><span class="wpspx-price-symbol">'+ currencyChar + $.number( totalprice, currencyDecimalPlaces)+'</span></div><div class="view-additional-details"><i class="far fa-info-circle"></i></div><div class="additional-details"><dl><dt>Starting:</dt><dd>'+startDate+'</dd><dt>Ending:</dt><dd>'+expiryDate+'</dd><dt>Auto renew?:</dt><dd>'+ms.membership.autoRenew+'</dd></dl></div></div></div>');
		});
		...
		$.each(eventMatches, function(i, ti) {
			...
			itemList.push('<div class="wpspx-basket-item data-basket-id="'+basketId+'""><div class="wpspx-item-info"><div class="wpspx-title"><span>'+ti.name+'</span></div><div class="amount"><span class="wpspx-price-symbol">'+currencyChar+$.number( orginalprice, currencyDecimalPlaces)+'</span></div><div class="view-additional-details"><i class="far fa-info-circle"></i></div><div class="additional-details"><dl><dt>Seat:</dt><dd>'+ti.seatName+'('+ti.planName+')</dd></div></div></div>');
		});
